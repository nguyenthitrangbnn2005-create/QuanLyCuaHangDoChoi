...
public class DanhSachLegoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_danhsach_lego);
        ...
        java.util.ArrayList<Product> products = productDAO.getProductsByCategory("Lego");
        ...
        if (danhSach.isEmpty()) {
            danhSach.add(new CartItem("Lego City",    "299.000đ", R.drawable.lego_city));
            danhSach.add(new CartItem("Lego Ninjago", "399.000đ", R.drawable.lego_ninjago));
            danhSach.add(new CartItem("Lego Technic", "599.000đ", R.drawable.lego_technic));
            danhSach.add(new CartItem("Lego Creator", "499.000đ", R.drawable.lego_creator));
            danhSach.add(new CartItem("Lego Friends", "349.000đ", R.drawable.lego_friends));
        }
        CategoryProductAdapter adapter = new CategoryProductAdapter(this, danhSach, "Lego");
